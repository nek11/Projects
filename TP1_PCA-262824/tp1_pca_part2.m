...
evaluate_image_compression(cimg, ApList, muList, img, p);
...
% EVALUATION DO NOT MODIFY
evaluate_compression_rate(cr, cSize, img, cimg, ApList, muList);
...
% EVALUATION DO NOT MODIFY
evaluate_image_reconstruction(rimg, cimg, ApList, muList);
